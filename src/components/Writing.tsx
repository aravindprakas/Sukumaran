...
const articles = [
  {
    title: 'Biggest Sales Mistakes to Avoid in 2026',
    publication: 'Srushti Blog',
    year: '2026',
    link: '#',
  },
  {
    title: 'How AI is Revolutionizing the Sales Process',
    publication: 'Sales Insights Magazine',
    year: '2025',
    link: '#',
  },
  {
    title: 'Stop Over-Promising and Under-Delivering',
    publication: 'Business Growth Journal',
    year: '2025',
    link: '#',
  },
  {
    title: 'Why Your Prospects Won\'t Find You on Their Own',
    publication: 'Srushti Blog',
    year: '2024',
    link: '#',
  },
    ...
    <section id="writing" className="section-padding">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div {...fadeInUp} className="mb-16">
          <span className="text-sm text-gray-500 tracking-widest uppercase">Insights & Articles</span>
