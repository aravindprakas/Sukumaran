...
const contacts = [
  { label: 'INDIA', type: 'location', link: '#' },
  { label: 'MIDDLE EAST', type: 'location', link: '#' },
]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-sm text-gray-500 tracking-widest uppercase">
            BOOK A FREE CONSULTATION WITH SUKUMAR
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 md:gap-16">
            <a
              href="mailto:sukumar@srushti.com"
        ...
        >
          <p className="text-xs text-gray-600">
            © {new Date().getFullYear()} Srushti Management Services. All rights reserved.
          </p>
          <p className="text-xs text-gray-600">
            India / Middle East
          </p>
