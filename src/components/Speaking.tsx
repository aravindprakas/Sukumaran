...
const talks = [
  {
    title: 'Avoid Assuming Prospects Will Find You',
    event: 'Sales Summit India',
    year: '2026',
    link: '#',
  },
  {
    title: 'Stop Spending Too Much Time "Preparing"',
    event: 'Business Growth Conference',
    year: '2025',
    link: '#',
  },
  {
    title: 'The Art of Asking Tough Questions in Sales',
    event: 'Srushti Sales Masterclass',
    year: '2025',
    link: '#',
  },
  {
    title: 'AI-Powered Prospecting: The Future of Sales',
    event: 'TechSales Forum',
    year: '2024',
    link: '#',
  },
  {
    title: 'Building a Predictable Revenue Engine',
    event: 'Entrepreneur India Summit',
    year: '2024',
    link: '#',
  },
]
    ...
    <section id="speaking" className="section-padding bg-[#0d0d0d]">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div {...fadeInUp} className="mb-16">
          <span className="text-sm text-gray-500 tracking-widest uppercase">Talks & Masterclasses</span>
